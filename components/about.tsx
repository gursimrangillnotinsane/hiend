...
const AboutSection = () => {
    return (
        <section
            className="section styles_section__wwoJW"><div
                className="styles_container__VvCHC"><div
                    className="styles_block__K5nIf styles_left__i3WQf"><h3
                        className="styles_left__heading__VK6df title title-60">Transforming
                        Spaces<br />
                        With Custom Lighting<br />
                        Innovation & Excellence</h3><p
                            className="styles_left__text__pTdct text">Results from a
                        partnership with Hi-end after 36 months of tailored
                        lighting solutions:</p><div
                            className="styles_left__numbers__EZl70"><div
                                className="styles_number__VnznC border-radius"><div
                                    className="styles_number__value__ayTB4 title title-60">567<sub>%</sub></div><p
                                        className="styles_number__text__FRNy7 text">Increase
                                in
                                ambient <br /> lighting
                                efficiency</p></div><div
                                    className="styles_number__VnznC border-radius"><div
                                        className="styles_number__value__ayTB4 title title-60">500</div><p
                                            className="styles_number__text__FRNy7 text">
                                Custom installations <br />
                                completed annually</p></div><div
                                    className="styles_number__VnznC border-radius"><div
                                        className="styles_number__value__ayTB4 title title-60">Top<sup>5</sup></div><p
                                            className="styles_number__text__FRNy7 text">Ranked
                                among the<br />
                                fastest-growing lighting
                                companies</p></div></div></div><div
                                    className="styles_block__K5nIf styles_right__fLwu_"><div
                                        className="styles_right__shape__S6cyG"><div
                                            className="pin-spacer"
                                            style={{ order: '0', placeSelf: 'auto', gridArea: ' auto', zIndex: 'auto', float: 'none', flexShrink: '1', display: 'block', margin: '0px', inset: 'auto', position: 'relative', flexBasis: 'auto', overflow: 'visible', boxSizing: 'border-box', width: '152px', height: '659px', padding: '0px 0px 504px' }}><div
                                                className="styles_right__shapeInner__od0tH"
                                                style={{ translate: 'none', rotate: 'none', scale: 'none', inset: ' 0px auto auto 0px', margin: '0px', maxWidth: '151.681px', width: '151.681px', maxHeight: '155.236px', height: '155.236px', padding: '0px', transform: 'translate(0px, 504px) rotate(180deg)' }}><svg
                                                    fill="none" viewBox="0 0 101 101"
                                                    className="styles_shape__B3q9p styles_right__shapeSvg__uGpEA title-80"><path
                                                        ...
                                                        strokeLinejoin="round"></path><path
                                                            ...
                                                            strokeLinejoin="round"></path><path
                                                                ...
                                                                strokeLinejoin="round"></path><path
                                                                    ...
                                                                    stroke="#010561" strokeWidth="2"
                                                                    strokeLinecap="round"
                                                                    strokeLinejoin="round"></path></svg></div></div></div><div
                        ...
                        is rooted in the innovative design trends that have
                        shaped the lighting and curbing industries. With
                        years of expertise, we specialize in creating custom
                        lighting solutions and precision curbing that
                        elevate spaces and enhance functionality.</p><a
                            aria-label="Book a Consultation"
                            className="styles_button__DwtwR styles_right__button__bVlJn button-text"
                            rel="noreferrer"
                            href="/contactus"><div
                                className="styles_button__container__kKhYm border-radius"><div
                                    className="styles_button__svgContainer__5Xqdx border-radius"
                                    style={{ translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(-6.15em, 0px)' }}><svg
                                        className="styles_arrowLeft__0RHHo"
                                        viewBox="0 0 12 10" fill="none"
                                        style={{ translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(2.878em, 0px) scale(0, 0)' }}><path
                                            ...
                                            strokeLinejoin="round"></path></svg></div><div
                                                ...
                                                style={{ translate: "none", rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)' }}><span>Get
                                                    a Quote</span><svg
                                                        className="styles_arrowRight__82iX_"
                                                        viewBox="0 0 12 10" fill="none"
                                                        style={{ translate: "none", rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)' }}><path
                                                            d="M6.7 1l3.9 4m0 0L6.7 9m3.9-4H1"
                                                            strokeWidth="2"
                                                            strokeLinecap="round"
                                                            strokeLinejoin="round"></path></svg></div></div></a></div></div>
        </section>
